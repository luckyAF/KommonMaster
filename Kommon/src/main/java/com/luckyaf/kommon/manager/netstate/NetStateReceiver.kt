...
class NetStateReceiver private constructor() : BroadcastReceiver() {
    ...
    companion object {
        ...
        const val CUSTOM_ANDROID_NET_CHANGE_ACTION = "com.luckyaf.kommon.CONNECTIVITY_CHANGE"
    ...
    override fun onReceive(context: Context?, intent: Intent?) {
        ...
        if (intent.action.equals(ANDROID_NET_CHANGE_ACTION,true)
            ...
            NetStateManager.notifyNetworkState(NetworkUtils.getNetworkType(context))
